...
object FrogoSettings {

    const val NAME_APP = "Sample Kotlin Library"

    const val APP_DOMAIN = "com"
    const val APP_PLAY_CONSOLE = "frogobox"
    const val APP_NAME = "samplekotlin"

    const val LIBRARY_NAME_SDK = "simple"
    const val LIBRARY_NAME_CORE_SDK = "sample"

    const val MODULE_NAME_SDK = "simples"
    const val MODULE_NAME_CORE_SDK = "samples"
